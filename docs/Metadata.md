<sub><sup>[[Home]] > [[Componente]] > [[Componentes SEO]] > Metadata</sup></sub>

Este componente debe ponerlo dentro del [[Componente Head]], en el están todas las descripciones necesarias para que tu sitio sea encontrado por **google** y compartido en **redes sociales**.
...
<!-- meta generico -->
    <meta charset="utf-8"/><!-- necesario para leer caracteres especiales como acentos, ñ, etc... -->
    <meta http-equiv="X-UA-Compatible" content="IE=edge" /><!-- explicita compatibilidad -->
    <meta name="viewport" content="width=device-width, initial-scale=1.0" /><!-- necesario para que el sitio sea responsive -->
...
<!-- canonical, le entraga un url libre de filtros a los buscadores  -->
    <link rel="canonical" href="{{current_url}}"/>
    <meta property="og:url" content="{{current_url}}">
    <meta property="og:site_name" content="{{ site.name }}" />
<!-- robots: indica permitirdos por el sitio--> 
...
<!-- end meta generico -->
<!-- favicon: icono que se muestra en la pestaña -->
...
{%elsif current_url contains '/article/' %}
    <!-- meta articulo -->
        ...
        <!-- img -->
        <meta name="twitter:image" content="{% if article.image.size > 0%}{{article.image | image_url}}{%else%}{{site.logo}}{%endif%}">
        <meta property="og:image" content="{% if article.image.size > 0%}{{article.image | image_url}}{%else%}{{site.logo}}{%endif%}">
    <!-- end meta articulo -->
